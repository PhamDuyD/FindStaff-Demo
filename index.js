...
var staff2 = new Employee(2,'Alex',28,'back-end',750);
var staff3 = new Employee(1,'Lily',25,'front-end',600);
var staff4 = new Employee(1,'Rebeca',28,'back-end',750);
var staff5 = new Employee(1,'Lucas',25,'front-end',600);
var staff6 = new Employee(2,'Ben',30,'full-stack',750);
var staff7 = new Employee(2,'Bob',22,'front-end',600);
var staff8 = new Employee(1,'Thomas',26,'back-end',600);
var staff9 = new Employee(2,'Jane',22,'front-end',600);
var staff10 = new Employee(1,'Clover',28,'front-end',750);
var staff11 = new Employee(2,'Angela',26,'back-end',500);
var staff12 = new Employee(1,'Arian',25,'front-end',600);
var staff13 = new Employee(2,'Ash',28,'back-end',750);
var staff14 = new Employee(2,'Bella',30,'full-stack',750);
var staff15 = new Employee(2,'Caryln',25,'front-end',600);
var staff16 = new Employee(1,'Freya',26,'back-end',500);
var staff17 = new Employee(1,'Ken',25,'front-end',600);
var staff18 = new Employee(1,'Dan',30,'full-stack',750);
var staff19 = new Employee(2,'Zac',26,'back-end',600);
var staff20 = new Employee(1,'Alan',28,'full-stack',750);
